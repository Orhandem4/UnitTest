...
public class Test04_RepeatTestMultipleTimes {
    ...
    @RepeatedTest(5)
    void testMathExact2(){ // kendi değişikliğim ie yaptım

        int sayi1 = rm.nextInt(10);
        int sayi2 = rm.nextInt(10);

        int toplam = Math.addExact(sayi1,sayi2);

        assertEquals(sayi1+sayi2 , toplam);
        System.out.println("sayi1 : " + sayi1 + " sayi2 : " + sayi2 + " toplam = " + toplam );
    }
